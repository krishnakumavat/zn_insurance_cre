		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Insurance Plan Create",
									"targetURL": "#zninsurancecre-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zninsurancecre-display": {
								"semanticObject": "zninsurancecre",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zninsurancecre",
									"url": sap.ui.require.toUrl("zninsurancecre")
								}
							}
						}
					}
